/*
  ...
  - You are about to alter the column `original_price` on the `Product` table. The data in that column could be lost. The data in that column will be cast from `Decimal(10,2)` to `Integer`.
...
ALTER COLUMN "original_price" SET DATA TYPE INTEGER;
